...
Vuetronic come with all you need to write efficient and well tested code. We configured `Jest` to run unit tests suites and `Playwright` to run tests suites against your bundled `electron` application.
